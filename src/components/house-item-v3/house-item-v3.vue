    ...
    <div class="house-item-v3">
        <div class="item-inner">
            ...
            <div class="infos">
                ...
                <div class="price">
                    <div class="new">￥{{ itemData.finnalPrice }}</div>
                    <div class="old">￥{{ itemData.productPrice }}</div>
                    <div class="tip" v-if="itemData.pirceTipBadge">{{ itemData.pirceTipBadge.text }}</div>
                </div>
            </div>
        </div>
    </div>
...
<style lang="less" scoped>
    .house-item-v3 {
        ...
        .price {
            ...
            .tip {
                background-image: linear-gradient(270deg,#f666,#ff9f9f);
                color: #fff;
                padding: 0 6px;
                border-radius: 8px;
            }
